...
class DroneControlSystem:
    ...
    def update_position(self, x, y):
        """Обновить координаты дрона."""
        self.position = (x, y)

    def change_altitude(self, altitude):
        """Обновить высоту полета."""
    ...
    def consume_battery(self, consumption):
        """Понизить уровень заряда батареи."""
        self.battery -= consumption

    def check_battery(self):
        """Вернуть текущий уровень заряда батареи."""
        return self.battery
...
class DroneInterface:
    ...
    def show_status(self, drone_model):
        """Вывести информацию о текущем состоянии дрона."""
        return {
